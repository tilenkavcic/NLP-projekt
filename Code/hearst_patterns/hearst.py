...
if __name__ == '__main__':
    p = argparse.ArgumentParser(
        description='Extract hearst pattern pairs from a file or directory of files')
    p.add_argument('source', nargs="?", default='stdin',
                   help='input text file or directory of files')
    p.add_argument('-o', '--outfile', nargs='?', default=sys.stdout,
                   help='file for output, defaults to stdout')
